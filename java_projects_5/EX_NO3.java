...
// Super class - CashTree (ATM Machine)
class CashTree {
...
class SBI_Bank extends CashTree {
    ...
    public SBI_Bank(String name, int codeno, String location) {
        ...
        this.serviceCharge = 1.5; // SBI service charge
        this.interestRate = 4.0; // SBI interest rate
        this.maxWithdrawalLimit = 50000.0; // SBI max withdrawal limit
    }
...
class HDFC_Bank extends CashTree {
    ...
    public HDFC_Bank(String name, int codeno, String location) {
        super(name, codeno, location);
        this.serviceCharge = 2.0; // HDFC service charge
        this.interestRate = 3.5; // HDFC interest rate
        this.maxWithdrawalLimit = 60000.0; // HDFC max withdrawal limit
    }
...
public class EX_NO3 {
    public static void main(String[] args) {
        ...
        // Create ATM machines for SBI and HDFC banks
